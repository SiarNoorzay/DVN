...
- (void)viewDidLoad
{
    ...
    self.resultLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 20, TEXTAREA_WIDTH, TEXTAREA_HEIGHT)];
    ...
    [self addButtonWithTitle:@"Clear"      tag:kButtonAC           row:1 column:0 width:1 height:1];
